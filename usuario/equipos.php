    ...
    <?php
      ...
      echo "<div class='row justify-content-center'>";
          while($obj = $result->fetch_object()){   
            ...
            echo "<div class='card'>";
            echo "<div class='d-flex align-items-center' style='witdh:220px;height:270px'><img class='rounded mx-auto d-block img-fluid' width='220px' height='220px' src='".$obj->foto."'id='hoverfotos'/></div>";
