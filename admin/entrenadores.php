      ...
      <?php
          ...
          while($obj = $result->fetch_object()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='editarentrenador.php?id=$obj->identrenador'><img src='editar.jpg' width='40px' height='40px'/></a></td>";
                echo "<td><a href='eliminarentrenador.php?id=$obj->identrenador'><img src='eliminar.png' width='30px' height='30px'/></a></td>";
              echo "</tr>";
          }
