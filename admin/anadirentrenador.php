...
//CREACION VARIABLE GET
    ...
    <form action="anadirentrenador.php" method="post" enctype="multipart/form-data">
  ...
  //CREAMOS LA CONEXION
    ...
    $query="INSERT INTO entrenador (nombre, apellidos, dni, fechanacimiento, numerolicencia, telefono, direccion,foto)
            VALUES ('".$_POST['nom']."','".$_POST['ape']."','".$_POST['dni']."','".$_POST['fec']."','".$_POST['num']."','".$_POST['tfno']."','".$_POST['dir']."','$target_file')";
    echo $query;
