...
<div class="row">
  ...
  <div class="form-group">
      <label for="sel1">Jugador:</label>
        <select class="form-control" id="sel1" name="jugador" required>
        <option value="" disabled hidden selected>Añade un jugador</option>
          <?php
    ...
    <div class="form-group">
      <label for="sel1">Equipo:</label>
        <select class="form-control" id="sel1" name="equipo" required>
    ...
    <div class="form-group">
      <label for="sel1">Temporada:</label>
        <select class="form-control" id="sel1" name="temporada" required>
  ...
  <div class="col-md-2">
    <div class="form-group justify-content-center">
        ...
        <div class="col-10">
            <input class="form-control" type="number" value="" name="numero" id="example-number-input">
        </div>
    </div>
  </div>
  </div>
