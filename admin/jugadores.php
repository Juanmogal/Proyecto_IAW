      ...
      <?php
          ...
          while($obj = $result->fetch_object()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='editarjugador.php?id=$obj->idjugador'><img src='editar.png' width='35px' height='35px'/></a></td>";
                echo "<td><a href='eliminarjugador.php?id=$obj->idjugador'><img src='borrar.png' width='35px' height='35px'/></a></td>";
              echo "</tr>";
          }
