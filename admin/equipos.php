      ...
      <?php
          ...
          while($obj = $result->fetch_object()) {
              ...
              echo "<tr>";
                ...
                echo "<td><a href='editarequipo.php?id=$obj->idequipo'><img src='editar.png' width='35px' height='35px'/></a></td>";
                echo "<td><a href='eliminarequipo.php?id=$obj->idequipo'><img src='borrar.png' width='35px' height='35px'/></a></td>";
